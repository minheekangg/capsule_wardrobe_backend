...
# MINHEES CLOSET
mi2 = Item.create(name: "Cropped Wide Leg Pants", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/tw5s7ftvcteagiupuyu4.jpg", category_id: bottoms.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
m26=Item.create(name: "Jeans", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/veronicabeardskirt.jpg", category_id: bottoms.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
m13=Item.create(name: "Jeans", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/clwvkizsmkhxzj2vxmy0.jpg", category_id: bottoms.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
...
m22 =Item.create(name: "Commes des Garcons", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/ac6d9tyhzx8tzxhhxodp.png", category_id: shoes.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 4)
m110 =Item.create(name: "Acne Boots", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/vxktjcg9gjwxyjxjjob0.jpg", category_id: shoes.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 3)
m15 =Item.create(name: "Navy Top", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/p6brbwohpx0yfzwrcr8h.jpg", category_id: tops.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
m27 =Item.create(name: "Top", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/JYVV105PSS19BLK_1.jpg", category_id: tops.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
m16 =Item.create(name: "Navy Work Pants", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/hvgddwmbufkvzojuzwzc.jpg", category_id: bottoms.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 2)
m25 =Item.create(name: "White Pants", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/cvcryjbpfeqqzjhfeafd.jpg", category_id: bottoms.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
m17 =Item.create(name: "DVF Sweater", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/m8dvg2ilnsd7jxx1f5a8.jpg", category_id: sweatshirts.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
...
mi9 =Item.create(name: "Camel Coat", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/pyaw25nwumhon8opp0ej.jpg", category_id: outerwears.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 2)
mi10 =Item.create(name: "Jacket", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/dlwnx01qbh2d2ekrasdg.jpg", category_id: outerwears.id, user_id: minhee.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1)
...
e1 = Item.create(name: "blazer" , image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/nsastrs0dnb3qt78q5bv.jpg" , category_id:outerwears.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 2 )
e3 = Item.create(name: "Day Heels", image: "https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/rqsiynukjtx2miwj6eyf.jpg", category_id: shoes.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 4 )
e4 = Item.create(name: "Jeans" , image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/dh4krhj7cm3oe7sx4ef9.jpg" , category_id: bottoms.id , user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
e5 = Item.create(name: "Cargo Pants", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/zcdjwkpy3pvbhtmp97zk.jpg" , category_id: bottoms.id , user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 2 )
e6 = Item.create(name: "Black Jeans", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/lhftdegdpj8jdefnbplw.jpg" , category_id: bottoms.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 3 )
e7 = Item.create(name: "Chelsea Boots" , image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/bb0crt5iygnc6c2lzrsa.jpg" , category_id: shoes.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 3 )
dayheels = Item.create(name: "Red Day Heels" , image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/yaiux7lw0pfzkvf1ulr5.jpg" , category_id: shoes.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
e8 = Item.create(name: "Jacket", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/ydebkoxwsw1g7ds5l1ck.jpg" , category_id: outerwears.id , user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
e9 = Item.create(name: "Coat" , image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/cx96kovrungybvrzxxc4.jpg" , category_id: outerwears.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
e10 = Item.create(name: "Black Dress", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/cbpfejtarsok1satht4g.jpg" , category_id: dresses.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
e11 = Item.create(name: "Turtleneck", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/jg3mpaa45kiidequ4o7m.jpg" , category_id: tops.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
...
e13 = Item.create(name: "Pink Turtleneck", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/izdqo4ibgcxd9gum7ztd.jpg" , category_id: tops.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
...
e141 = Item.create(name: "stripedshirt", image:"https://res.cloudinary.com/#{ENV["cloudinary_name"]}/image/upload/#{ENV["cloudinary_img_setting"]}/#{ENV["cloudinary_folder"]}/dsjzujtxzvw32lxbzj3j.jpg" , category_id: tops.id, user_id:everlane.id, updated_at: "2018-12-29 00:00:00".to_date, times_worn: 1 )
